...
process.source = cms.Source("PoolSource",
   fileNames = cms.untracked.vstring('/store/data/Run2016E/RPCMonitor/RAW/v2/000/277/420/00000/9A41754B-B052-E611-8CAE-02163E01346F.root')
)
...
process.museg = cms.EDAnalyzer("MuonSegmentEff",
    ...
    EffRootFileName = cms.untracked.string('/tmp/carrillo/eff9A41754B-B052-E611-8CAE-02163E01346F.root'),
