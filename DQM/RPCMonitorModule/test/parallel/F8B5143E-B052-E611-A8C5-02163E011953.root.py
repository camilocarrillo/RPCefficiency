...
process.source = cms.Source("PoolSource",
   fileNames = cms.untracked.vstring('/store/data/Run2016E/RPCMonitor/RAW/v2/000/277/420/00000/F8B5143E-B052-E611-A8C5-02163E011953.root')
)
...
process.museg = cms.EDAnalyzer("MuonSegmentEff",
    ...
    EffRootFileName = cms.untracked.string('/tmp/carrillo/effF8B5143E-B052-E611-A8C5-02163E011953.root'),
