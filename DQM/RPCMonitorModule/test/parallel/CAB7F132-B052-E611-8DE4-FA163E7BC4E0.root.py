...
process.source = cms.Source("PoolSource",
   fileNames = cms.untracked.vstring('/store/data/Run2016E/RPCMonitor/RAW/v2/000/277/420/00000/CAB7F132-B052-E611-8DE4-FA163E7BC4E0.root')
)
...
process.museg = cms.EDAnalyzer("MuonSegmentEff",
    ...
    EffRootFileName = cms.untracked.string('/tmp/carrillo/effCAB7F132-B052-E611-8DE4-FA163E7BC4E0.root'),
