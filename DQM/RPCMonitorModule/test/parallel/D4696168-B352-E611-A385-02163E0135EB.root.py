...
process.source = cms.Source("PoolSource",
   fileNames = cms.untracked.vstring('/store/data/Run2016E/RPCMonitor/RAW/v2/000/277/420/00000/D4696168-B352-E611-A385-02163E0135EB.root')
)
...
process.museg = cms.EDAnalyzer("MuonSegmentEff",
    ...
    EffRootFileName = cms.untracked.string('/tmp/carrillo/effD4696168-B352-E611-A385-02163E0135EB.root'),
