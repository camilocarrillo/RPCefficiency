...
process.source = cms.Source("PoolSource",
   fileNames = cms.untracked.vstring('/store/data/Run2016E/RPCMonitor/RAW/v2/000/277/420/00000/2678D0D9-B352-E611-B4F2-02163E011885.root')
)
...
process.museg = cms.EDAnalyzer("MuonSegmentEff",
    ...
    EffRootFileName = cms.untracked.string('/tmp/carrillo/eff2678D0D9-B352-E611-B4F2-02163E011885.root'),
